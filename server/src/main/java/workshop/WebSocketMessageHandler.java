...
public class WebSocketMessageHandler implements WebSocketConnection {

    private static final WebSocketMessageHandler messenger = new WebSocketMessageHandler();

    public static WebSocketMessageHandler get() {
        return messenger;
    }
    ...
    public void message(WsMessageContext context) {
        System.out.println("workshop.Message");
